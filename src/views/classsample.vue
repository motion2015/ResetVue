<template>
  <Subpage :pagetit="'교재 샘플'">
    ...
    <b-form @submit="ClassCall">
      ...
      >
        <b-form-input id="class" v-model="form.name" type="text"></b-form-input>
      </b-form-group>
      <b-form-group
        id="form-group5"
        label="연락처"
      ...
      <b-form-group
        ...
        description=""
      >
        <b-form-checkbox value="paper" v-model="form.checkedtype"
          >종이책</b-form-checkbox
        >
        <b-form-checkbox value="ebooks" v-model="form.checkedtype"
          >전자책</b-form-checkbox
        >
        <b-form-checkbox value="ppt" v-model="form.checkedtype"
          >강의자료</b-form-checkbox
        >
      </b-form-group>
