    ...
    <div class="bookpage">
      <VueSlickCarousel class="subpagslider" v-bind="settings">
        <div class="rollimg" v-for="(item, index) in Newbooks" :key="index">
          <span class="imgbox"><img :src="item.imgurl" alt="" /></span>
        ...
        <div class="book-detailinfo">
          <div class="detailTap">
            ...
            <b-form-radio
              ...
              button
              button-variant="detailtap"
              ><i class="bi bi-chat-left-text" />출판사 리뷰</b-form-radio
            >
            <b-form-radio
              name="detail-tap"
              v-model="tapselect"
            ...
            <b-form-radio
              ...
              button
              button-variant="detailtap"
              ><i class="bi bi-journal-text" />저자 소개</b-form-radio
            >
            <b-form-radio
              name="detail-tap"
              v-model="tapselect"
              ...
              button
              button-variant="detailtap"
              ><i class="bi bi-person-check" />추천이 글</b-form-radio
            >
            <b-form-radio
              name="detail-tap"
              v-model="tapselect"
          ...
          <template v-if="tapselect === 'introduce'">
            <div class="detailTapCon">
              ...
              <p>
                ...
                작업 방식 그대로<br />웹 사이트 하나 통째로 만들면 나도 어느새
                웹 퍼블리셔!!<br />이 책 한 권이면 웹 사이트 하나가 뚝딱 완성
              </p>
            </div>
          </template>
          <template v-else-if="tapselect == 'review'">
            <div class="detailTapCon">
              ...
              <p>
                자신이 알고 있는 내용은 다른 사람과 나누고, 궁금한 내용은 나와
                비슷한 고민을 하는 사람들과 함께 풀어보면 어떨까요? 지식을
                공유하는 뿌듯함과 함께 자신의 능력이 한층 더 발전되어 가는
                모습을 발견할 수 있을 거예요. 또한 Do it! 스터디룸에 공부 계획
                세우고 스터디 노트를 꾸준히 올리면 새 책을 받을 수 있어요.
                공부하고 책 받고 다시 공부하는 행복한 무한루프에 빠져 자신의
                능력을 키워보세요!<br /><br />

                - Do it! 스터디룸 카페 [cafe.naver.com/doitstudyroom → ‘웹
                사이트 따라 만들기’ 메뉴]<br />

                - Do it! 스터디룸 카페 [cafe.naver.com/doitstudyroom → ‘Do it!
                공부단 지원&책 선물 받기’ 메뉴]<br />
              </p>
            </div>
          </template>
          ...
          <template v-else-if="tapselect == 'write'">
            <div class="detailTapCon">
              ...
              <p>
                ...
                그녀는 일에 대한 열정이 가득하고 언제나 두려움 없이 새로운
                도전을 시작하는 실무 경력 13년 차 웹 퍼블리셔이다. 국내 웹
                에이전시에서 활동하며 이니스프리, 에뛰드, 엘지 하우시스 등
                유명한 쇼핑몰 제작에 참여했고 그동안 작업한 사이트 대부분은 웹
                어워드 코리아에서 각 분야별로 최우수상 또는 대상을 수상하였다.
                또한 웹 퍼블리싱 실무 강의로 인기를 끌기도 했다. 'Do it! 웹
                사이트 따라 만들기'는 그녀의 실무 경험과 강의 경험이 결합되어
                나온 책이다. 그녀의 업무 방식을 화면 그대로 정리해 이 책에
                빠짐없이 옮겨 담았으며 이 책을 읽는 독자들의 시간을 절약해주기
                위해 전체 소스도 공개했다. 이 소스를 그대로 활용하면 독자가
                필요한 웹사이트를 빠르게 만들 수 있다. 그녀는 현재 외국계
          ...
          <template v-else-if="tapselect == 'recommendation'">
            <div class="detailTapCon">
              ...
              <p>
                ...
                - HTML, CSS, 자바스크립트 문법은 조금 알지만 사이트를 직접 만든
                적 없는 코딩 초보자<br />
                - 웹 퍼블리셔가 되고 싶은 취업 준비생<br />
                - 실무에 익숙하지 않은 신입 웹 퍼블리셔<br />
                - 퍼블리싱도 함께 해야 하는 스타트업 기업의 웹 디자이너, 웹
                개발자<br />
