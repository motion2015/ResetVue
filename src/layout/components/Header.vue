  ...
  <header :class="Topclass">
    ...
    <b-modal id="login" class="modal" hide-footer>
      <template #modal-title>
        <div class="layertit">
          <i class="bi bi-clipboard-check"></i>로그인TTT
        </div>
      </template>
      ...
      <div class="modalcontainer">
        <b-form @submit="joinmember">
          <b-form-group
            ...
            label="아이디"
            label-for="id"
            description="4~15 자리 이내의 영문과 숫자로만 입력하세요"
          >
            <b-form-input
              id="id"
              v-model="form.id"
          ...
          <b-form-group
            ...
            label="이메일 수신"
            label-for="mailing"
            description="※ 이메일 수신을 허락하면 독자 혜텍을 받을 수 있어요."
          >
          ...
          <div class="btnwrap half">
            ...
            <b-button type="resest" variant="login">취소</b-button>
          </div>
        </b-form>
